...
var mapboxAttribution = '&copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> Contributors: ' +
			'<a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a> | <a href = "https://raw.githubusercontent.com/Mburu-coder/OnlineAssignment_0/master/JSON/restaurants.geojson"> Data </a> by Mburu Eileen | Author: Mburu Eileen |' +
...
var baseMaps = {
    ...
    "Streets": streets
        ...
        for (i in restaurantsData) {
            var latlng = L.latLng({
                lat: restaurantsData[i].address.coord[1],
                lng: restaurantsData[i].address.coord[0]
            });

            var marker = L.marker(latlng, {
                icon: Icon
            }).bindPopup(`<b> Restaurant Name: </b>${restaurantsData[i].name}<br> <b> Cuisine: </b> ${restaurantsData[i].cuisine}<br> <b> Street: </b> ${restaurantsData[i].address.street} `);
